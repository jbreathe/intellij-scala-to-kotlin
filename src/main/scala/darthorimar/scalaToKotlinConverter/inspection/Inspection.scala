...
import org.jetbrains.kotlin.idea.inspections.{
  ExplicitThisInspection,
  KotlinDoubleNegationInspection,
  MoveLambdaOutsideParenthesesInspection
}
...
object Inspection {
  val inspections = Seq(
    ...
    new DiagnosticBasedInspection(
      Seq(Errors.UNSAFE_CALL), { (element: KtElement, diagnostic: Diagnostic, project: Project, file: PsiFile) =>
